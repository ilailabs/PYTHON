"""
prints the postion and displacement in .csv file
"""

##to calculate the position, disp, eng of all atoms;
var1_name='Position'
var2_name='c_dsp[1]'
#var2_name='c_eng'
import sys
...
for frame in range(0,numframes,100):
	for particle_id in range(0,1600,40):
...
#	plt.ylim(0.00, 0.00008)
	...
	plot_name=var2_name+'_'+str(frame)+'_'+str(particle)+'.png'
